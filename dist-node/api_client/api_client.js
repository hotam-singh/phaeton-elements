...
var getUserAgent = function getUserAgent() {
	...
	var phaetonElementsInformation = 'PhaetonElements/1.0 (+https://github.com/PhaetonHQ/phaeton-elements)';
	...
	return name + '/' + version + ' (' + engine + ') ' + phaetonElementsInformation + ' ' + systemInformation;
};
...
var APIClient = function () {
	...
	(0, _createClass3.default)(APIClient, [{
		...
		value: function createMainnetAPIClient(options) {
			return new APIClient(constants.MAINNET_NODES, (0, _assign2.default)({}, { nethash: _phaetonConstants.MAINNET_NETHASH }, options));
		}
	}, {
		key: 'createTestnetAPIClient',
		value: function createTestnetAPIClient(options) {
			return new APIClient(constants.TESTNET_NODES, (0, _assign2.default)({}, { nethash: _phaetonConstants.TESTNET_NETHASH }, options));
		}
	}, {
		key: 'constants',
		get: function get() {

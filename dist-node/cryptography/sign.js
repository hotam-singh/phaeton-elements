...
var signedMessageHeader = createHeader('BEGIN PHAETON SIGNED MESSAGE');
...
var signatureFooter = createHeader('END PHAETON SIGNED MESSAGE');

var SIGNED_MESSAGE_PREFIX_BYTES = Buffer.from(_phaetonConstants.SIGNED_MESSAGE_PREFIX, 'utf8');
var SIGNED_MESSAGE_PREFIX_LENGTH = (0, _varuintBitcoin.encode)(_phaetonConstants.SIGNED_MESSAGE_PREFIX.length);

...
var getTransactionBytes = function getTransactionBytes(transaction) {
	...
	var transactionRecipientID = recipientId ? _cryptography2.default.bigNumberToBuffer(recipientId.slice(0, -1), _constants.BYTESIZES.RECIPIENT_ID) : Buffer.alloc(_constants.BYTESIZES.RECIPIENT_ID);
	...
	if (amountBigNum.gte((0, _browserifyBignum2.default)(_phaetonConstants.MAX_TRANSACTION_AMOUNT).plus(1))) {
